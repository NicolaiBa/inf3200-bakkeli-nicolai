...
# Executable
directory="/home/nba014/inf-3200/Assignment1/mandatory/assignment1/src/" #current working directory
executable="node.py";
...
do
  ...
  nohup ssh $node bash -c "'python $directory$executable grep da * 2> G-E-$node.txt'"  > /dev/null 2>&1 &
done
